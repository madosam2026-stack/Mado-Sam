...
const CartSidebarModal = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-99999 overflow-y-auto no-scrollbar w-full h-screen bg-[#F5BE32]/20 ease-linear duration-300 ${
      ...
      <div className="flex items-center justify-end">
        <div className="w-full max-w-[500px] shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          <div className="sticky top-0 bg-white flex items-center justify-between pb-7 pt-4 sm:pt-7.5 lg:pt-11 border-b border-gray-3 mb-7.5">
            <h2 className="font-medium text-[#F5BE32] text-lg sm:text-2xl">
              Cart View
            </h2>
            <button
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            ...
            <div className="flex items-center gap-4">
              ...
              borderRadius: "2px",
                ...
                onClick={() => closeCartModal()}
                href="/cart"
                className="w-full inline-flex items-center justify-center gap-3 font-medium bg-[#F5BE32] text-[#000000] transition-all  py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-[#F5BE32]/50"
              >
                View Cart
                <span className="line block h-[2px] w-8 bg-[#000000] transition-all"></span>
              </Link>
